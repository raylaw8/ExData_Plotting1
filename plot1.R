...
sub_global_active_power = subset(power$Global_active_power, power$Date=="1/2/2007" | power$Date=="2/2/2007" )

#convert to numeric
conv_global_active_power = as.numeric(as.character(sub_global_active_power))

#draw histogram
hist(conv_global_active_power,xlab="Global Active Power (kilowatts)",col="red",main="Global Active Power")
